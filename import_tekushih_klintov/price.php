...
include('db_conn.php');
$max_file_size = 99999; // Максимальный размер файла в МегаБайтах
if($_POST['update']=='OK'){
    ...
    for ($i=1; $i<=$data->sheets[0]["numRows"]; $i++){
        ...
        $ins="INSERT INTO `tekkli` (`data`,`inn`,`kpp`,`value`,`produkt`,`sostoyanie`,`komm`,`kontakti`,`prod`,`genkluch`)VALUES('$cell1','$cell2','$cell3','$cell4','$cell5','$cell6','$cell7','$cell8','$cell9','$cell10')";
