...
<!-- Begin Banner -->
<TR><TD><TABLE CELLPADDING="2" CELLSPACING="0" BORDER="0" BGCOLOR="#cecece" WIDTH="100%"><TR><TD><TABLE BGCOLOR="#1c5280" WIDTH="100%" CELLPADDING="0" CELLSPACING="0" BORDER="0"><TR><TD CLASS="Banner" /></TR><TR><TD CLASS="Banner"><SPAN CLASS="BannerTextCompany" /></TD></TR><TR><TD CLASS="Banner"><SPAN CLASS="BannerTextApplication">CRM</SPAN></TD></TR><TR><TD CLASS="Banner" ALIGN="RIGHT" /></TR></TABLE></TD></TR></TABLE></TD></TR>
<!-- End Banner -->
...
<!-- Begin AppInfo -->
<TABLE><TR><TD COLSPAN="3">&nbsp;</TD></TR><TR><TD><B>Имя:</B></TD><TD WIDTH="5"><SPACER TYPE="block" WIDTH="10" /></TD><TD>CRM</TD></TR><TR><TD COLSPAN="3">&nbsp;</TD></TR><TR><TD><B>Версия:</B></TD><TD WIDTH="5"><SPACER TYPE="block" WIDTH="10" /></TD><TD>1.0.0.43</TD></TR><TR><TD COLSPAN="3">&nbsp;</TD></TR><TR><TD><B>Издатель:</B></TD><TD WIDTH="5"><SPACER TYPE="block" WIDTH="10" /></TD><TD /></TR><tr><td colspan="3">&nbsp;</td></tr></TABLE>
<!-- End AppInfo -->
...
<LI>Microsoft .NET Framework 4.6.1 (x86 и x64)</LI>
</UL></TD></TR><TR><TD COLSPAN="2">
Если эти компоненты уже установлены, приложение можно <SPAN CLASS="JustThisApp"><A HREF="CRM.application">launch</A></SPAN>. Иначе щелкните по кнопке ниже, чтобы установить необходимые компоненты и запустить приложение.
