...
">
<div>
<input class="btn btn-xs" type="submit" name="ingroup" value="Сгрупировать" style="margin-top: 35px;margin-left: 5px;
    padding-bottom: 1px; border-bottom-right-radius: 0; border-top-right-radius: 0;" />
<input class="btn btn-xs" type="submit" name="ungroup" value="Разгрупировать" style="margin-top: 35px;margin-left: 5px;
    padding-bottom: 1px; border-bottom-left-radius: 0; border-top-left-radius: 0;" /> 
<input class="btn btn-xs" type="submit" name="doljen" value="Должен" style="margin-top: 35px;margin-left: 5px;
    padding-bottom: 1px;" /> 
<input class="btn btn-xs" type="submit" name="doljenop" value="Должен оплатить" style="margin-top: 35px;margin-left: 5px;
    padding-bottom: 1px;" /> 
<?php
	if($userdata['otvetstven']==1){
		echo '
			<input class="btn btn-xs" type="submit" name="oplachen" value="Оплата" style="margin-top: 35px;margin-left: 5px;
    padding-bottom: 1px;" /> 
			<input class="btn btn-xs" type="submit" name="proveren" value="Готов" style="margin-top: 35px;margin-left: 5px;
    padding-bottom: 1px;" /> 
			<input class="btn btn-xs" type="submit" name="akt" value="В архив" style="margin-top: 35px;margin-left: 5px;
    padding-bottom: 1px;" /> 
...
?>
<!--<input class="btn  btn-xs" type="submit" name="cher" value="Отказались" style="margin-top: 35px;margin-left: 5px;
    padding-bottom: 1px;"  />!-->
<!--<input class="btn  btn-xs" type="submit" name="otk" value="В черновики" style="margin-top: 35px;margin-left: 5px;
    padding-bottom: 1px;"  />!-->
...
<input class="btn btn-xs" type="reset" id="deleteol" value="Убрать отмеченые" style="margin-top: 35px;margin-left: 5px;
    padding-bottom: 1px;" /> 
	<?php
	if($userdata['users_id']==20 ||$userdata['users_id']==17||$userdata['users_id']==4||$userdata['users_id']==4107||$userdata['users_id']==3||$userdata['users_id']==4120){
		echo '
			<input class="btn btn-xs" type="submit" name="postprod" value="Поставить продление" style="margin-top: 35px;margin-left: 5px;
    padding-bottom: 1px;"  /> 
...
<?/*php
	if($userdata['otvetstven']==1){
		echo '<input onclick=\'return confirm("Для удаления счета нажмите OK!");\' class="btn btn-xs" type="submit" name="deletemarked" value="Удалить" style="margin-top: 35px;margin-left: 5px;
    padding-bottom: 1px;" /> ';
	}
*/?>
</div>
...
FROM schet WHERE
del = '0' and idkli = '".$_GET['id']."' and ((akt='1') or (akt='0' and (cher=1 or otk ='1'))) group by rand ORDER BY id DESC ");
