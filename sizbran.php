...
<?php $i = 1;
$queryizb = mysql_query("SELECT * FROM schetizbran WHERE kto = ".$userdata['users_id']);
while($rowizb = mysql_fetch_array($queryizb)) {
...
FROM schet 
WHERE del = '0' AND rand='".$rowizb['schet']."'  ORDER BY id DESC LIMIT $start, $num ");
