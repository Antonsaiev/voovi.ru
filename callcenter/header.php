...
{
  include 'connect.php';
  $result=mysql_query("SELECT id,name,access_level FROM techs WHERE pin='".$_POST['login']."'") or die("Died on pin lookup.");
...
<html>
<head>
<title>PHP Call Center - <?php echo $_SESSION['name']; ?></title>
</head>
...
?>
<tr>
  <td colspan=6 align=center><font face=monospace size=2 color=#c0c0c0><a href=http://sourceforge.net/projects/phpcc target=_blank>phpCC</a> created by alandrums</font></td></tr>
</table>
  </td>
 </tr>
   ...
   <tr> 
    <td> 
     <table cellspacing=0 cellpadding=0 border=0 bgcolor=#234D76 width=100%> 
      <tr> 
       <td align=center bgcolor=white><font face=sans-serif size=3 color=#234D76><b>PHPCC LOG IN</b></font></td> 
      </tr><tr> 
       <td align=center><br> 
        <table cellspacing=0 cellpadding=3 border=0> 
         <tr> 
