...
$result=mysql_query("CREATE TABLE customers (id bigint(20) unsigned auto_increment,userid char(20),l_name char(20),f_name char(20),phone char(10),address char(40),city char(30),state char(3),zip char(9),system_speed tinyint(3) unsigned not null default '0',system_memory tinyint(3) unsigned not null default '0',system_os tinyint(3) unsigned not null default'0',system_connection tinyint(3) unsigned not null default '0',primary key (id))");
echo "<b>customers:</b> "; 
if(!$result) 
{ 
...
$result = mysql_query("CREATE TABLE techs (id smallint(5) not null auto_increment,pin char(10),name char(20),access_level tinyint(1) not null default '0',date int(11) not null default '0',calls_today tinyint(3) not null default '0',calls_week tinyint(3) not null default '0',calls_jan tinyint(3) not null default '0',calls_feb tinyint(3) not null default '0',calls_mar tinyint(3) not null default '0',calls_apr tinyint(3) not null default '0',calls_may tinyint(3) not null default '0',calls_jun tinyint(3) not null default '0',calls_jul tinyint(3) not null default '0',calls_aug tinyint(3) not null default '0',calls_sept tinyint(3) not null default '0',calls_oct tinyint(3) not null default '0',calls_nov tinyint(3) not null default '0',calls_dec tinyint(3) not null default '0',primary key (id))");
echo "<b>techs:</b> ";
if(!$result) 
{ 
  echo "creation failed.<br>"; 
...
$result = mysql_query("CREATE TABLE calls (user_id int(11),dt_start int(11) not null default '0',duration smallint(5) not null default '0',tech_id smallint(5) not null default '0',problem int(11) not null default '0',verified int(11) not null default '0',status tinyint(3) not null default'0',notes text)");
echo "<b>calls:</b> ";
if(!$result)
{
  echo "creation failed.<br>";
...
$result = mysql_query("CREATE TABLE config (type tinyint(3),name char(40),value int(11),display_order tinyint(3),other tinyint(3))");
echo "<b>config:</b> ";
if(!$result)
{
  echo "creation failed.<br>";
...
mysql_query("insert into techs (pin,name,access_level) values('1111111111','Default','3')");
...
{
  echo "Added successfully.<br><br>---------------------------------<br><br>All operations should be finished now.<br><br>Go to <a href=index.php>index.php</a> and log in with '1111111111' to begin.";
}
?>
