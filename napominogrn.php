	...
	<form action="" method="post"><div style="margin-top: 6px;"></div>
			...
			<select style="margin-bottom: 0px;" type="text" name="mir"  />
								...
								<option value="zv">Звонок</option>
								  ...
								  <option value="vv">Выставить счет</option>
...
Организация: <?php  echo $person['naim']; ?>;
ИНН: <?php  echo $person['inn']; ?></textarea>
	</div>
	<br>
...
<?php
										...
										$u = "INSERT INTO `napomin` (`dr`, `mr`, `gr`, `dmg`, `gor`, `chr`, `mir`, `tipz`, `tel`, `mestvs`, `opis`, `users`,`tip`,`produrl`) VALUES ('$_POST[dr]', '$_POST[mr]', '$_POST[gr]', '$_POST[gr]$_POST[mr]$_POST[dr]', '$_POST[gor]', '$_POST[chr]', '$_POST[mir]', '$_POST[tipz]', '$_POST[tel]', '$_POST[mestvs]', '$_POST[opis]', '".$userdata['users_id']."', '/kartklient.php?id=', '".$_GET['id']."')";
