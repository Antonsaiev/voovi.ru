...
">
        <tr>
		  ...
		  <th style="padding:4px;">Последнее обнавления</th>
		  <th style="width: 10px;padding:4px;"><i class="fa fa-file-excel-o"></i></th>
		  <th style="width: 10px;padding:4px;">Редактировать</th>
        </tr> 
    </thead>
<?php
						...
						$num = 30;
						$page = $_GET['page'];
						$result00 = mysql_query("SELECT COUNT(*) FROM organizacii");
						...
						$query = mysql_query("SELECT * from organizacii ORDER BY id DESC LIMIT $start, $num");	
							while($row = mysql_fetch_array($query)) {
								echo '<tr style="font-size: 12px;"><td style="padding:4px;">';
								echo $row['pn'];
								echo '</td>';
								...
								echo '<a style="color: #3b5998;" title="Редактировать" href="./modholmes.php?id=' .$row['id']. '">Редактировать</a>';
								echo '</td></tr>';
						}
					?>
				</table>
...
<div class="col-md-2">
<a class="col-md-12" href="./oholmes.php">
