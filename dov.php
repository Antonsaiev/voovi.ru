...
font-family:&quot;Times&quot;,&quot;serif&quot;;color:black">Довереность № <?php echo $res['nschet'].''.$res['id'];?> от&nbsp;<?php echo $date->format('d.m.Y');?></span></b></p>
...
line-height:normal;text-autospace:none"><b><span style="font-size: 16pt;
font-family:&quot;Times&quot;,&quot;serif&quot;;color:black"><?php echo $klient['naim'];?></span></b></p>
<br>
<p class="MsoNormal" align="center" style="margin-bottom:5.65pt;text-align:center;
line-height:normal;text-autospace:none"><b><span style="font-size: 16pt;
font-family:&quot;Times&quot;,&quot;serif&quot;;color:black"><b>ИНН:</b> <?php echo $savoir['inn'];?> <b><?php if ($savoir['kpp'] > 0){echo "КПП:";}?></b> <?php echo $savoir['kpp'];?></span></b></p>
<?php if ($savoir['kpp'] > 0)
{
	echo '
