...
<?php
										...
										if(isset($_GET['id'])){
										echo '<div class="alert alert-success"><strong>Удачно изменена!</strong></div>';
										}else{
										$u = "INSERT INTO `news` (`value`,`text`) VALUES ('$_POST[value]','$_POST[text]')";
										mysql_query($u) or die(mysql_error($link));	
										echo '<div class="alert alert-success"><strong>Удачно созданна!</strong></div>';
										}
										}
						...
						<strong><h4 style="margin-top: 10px; font-weight: bold; border-bottom: 1px #333 solid;">Добавить новость:</h4></strong>

	<form method="POST"><div style="margin-top: 6px;"></div>
	<div class="input-group">
			<span class="input-group-addon">Вопрос:</span>
			 <input name="value" value="<?php echo $person['value']; ?>" class="form-control" rows="2"/>
			 </div>
			 <div style="margin-top: 10px;"></div>
			 
			 <div class="input-group">
			<span class="input-group-addon">Ответ:</span>
			 <textarea id="editor" name="text" class="form-control" rows="5"><?php echo $person['text']; ?></textarea>
...
padding: 5px 15px; margin-top: -12px;">Новости.</h3>
