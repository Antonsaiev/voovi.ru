...
<form class="allcalltable">
    ...
    <table class="table" style="font-size: 12pt">
        ...
        <?php
        $nom=0;
        $r = mysql_query("SELECT *,vidcall.name_call,users.f_name,users.l_name,users.o_name,ogrn.naim from telefonia left join vidcall on telefonia.vid_call=vidcall.id left join users on telefonia.idkto=users.users_id left join ogrn on ogrn.id=telefonia.idkli where telefonia.idkli='' and telefonia.ns='' order by telefonia.id desc limit 50");
