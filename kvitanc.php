...
">
 <tr style='page-break-inside:avoid'>
  ...
  <b><?php echo $savoir['full_name'];?></b> <b>ИНН:</b> <?php echo $savoir['inn'];?> <b>ОГРН:</b> <?php echo $savoir['ogrn'];?> <b><?php if ($savoir['kpp'] > 0){echo "КПП:";}?></b> <?php echo $savoir['kpp'];?><br><b> Адрес: </b><?php echo $savoir['adres'];?>
  </td>
...
">
 <tr style='page-break-inside:avoid'>
  <td width=45 valign=top style='width:34.0pt;padding:0cm 0cm 0cm 0cm'>
  <b><?php echo $klient['naim'];?></b> <b>ИНН:</b> <?php echo $klient['inn'];?> <b>ОГРН:</b> <?php echo $klient['ogrn'];?> <b><?php if ($klient['kpp'] > 0){echo "КПП:";}?></b> <?php echo $klient['kpp'];?><br><b> Адрес: </b><?php echo $klient['uridadress'];?>
  </td>
...
style='font-size:10.0pt;font-family:"Times","serif";color:black'>Товарный чек № <?php echo $schet['id'];?> от&nbsp;<?php echo $schet['d'].'.'.$schet['m'].'.'.$schet['y'];?></span></b></p>
...
width: 50%;'>
 ...
 <tr>
  <td width=162 valign=top style='width:225.85pt;padding:0cm 0cm 0cm 0cm'>
  <p class=MsoNormal align=center style='margin-bottom:0cm;margin-bottom:.0001pt;
  text-align:center;line-height:normal;text-autospace:none'><span
