...
<?php $i = 1;
$query = mysql_query("SELECT * FROM schet WHERE del = '0' AND prod = '827'  OR prod = '828' OR prod = '829' OR prod = '861'  AND $groupi $getakt $turbo $gotov $goroddd $akt_date $gen_date $postavka $generac $oplachenks $oplachen $neoplachen $doljen $otk ORDER BY id DESC LIMIT $start, $num ");
