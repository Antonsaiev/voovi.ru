                                ...
                                <div class="widget-content-left">
                                    <div class="btn-group">
                                        <a data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="p-0 btn">
                                            <img width="42" class="rounded-circle" src="../img/<?php echo $userdata['img']; ?>" alt="">
                                            <i class="fa fa-angle-down ml-2 opacity-8"></i>
                                        </a>
                                        <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu dropdown-menu-right">
                                            <button type="button" tabindex="0" class="dropdown-item">Моя работа</button>
                                            ...
                                            <button type="button" tabindex="0" class="dropdown-item">Выйти</button>
                                        </div>
                                    </div>
                                </div>
                                <div class="widget-content-left  ml-3 header-user-info">
                                    <div class="widget-heading">
                                        <?php echo $userdata['f_name']; ?>&nbsp<?php echo $userdata['l_name']; ?>
                                    </div>
                                    <div class="widget-subheading">
                                        <?php $result57657 = mysql_query("SELECT * FROM doljnost WHERE id = '".$userdata['tip']."'");$row134 = mysql_fetch_array($result57657); echo $row134['name']; ?>
                                    </div>
                                </div>
